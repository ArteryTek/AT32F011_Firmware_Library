...
#if !defined (AT32F011C8T7)   && !defined (AT32F011K8U7_4) && !defined (AT32F011F8U7)   && \
    !defined (AT32F011F8P7)

    #error "Please select first the target device used in your application (in at32f011.h file)"
#endif
...
/**
  * define with package
  */
#if defined (AT32F011C8T7)

    #define AT32F011Cx
#endif

#if defined (AT32F011K8U7_4)

    #define AT32F011Kx
#endif

#if defined (AT32F011F8U7)   || defined (AT32F011F8P7)
...
/**
  * @brief at32f011 standard peripheral library version number
  */
#define __AT32F011_LIBRARY_VERSION_MAJOR    (0x02) /*!< [31:24] major version */
#define __AT32F011_LIBRARY_VERSION_MIDDLE   (0x00) /*!< [23:16] middle version */
#define __AT32F011_LIBRARY_VERSION_MINOR    (0x01) /*!< [15:8]  minor version */
#define __AT32F011_LIBRARY_VERSION_RC       (0x00) /*!< [7:0]  release candidate */
#define __AT32F011_LIBRARY_VERSION          ((__AT32F011_LIBRARY_VERSION_MAJOR << 24)  | \
                                             (__AT32F011_LIBRARY_VERSION_MIDDLE << 16) | \
                                             (__AT32F011_LIBRARY_VERSION_MINOR << 8)   | \
                                             (__AT32F011_LIBRARY_VERSION_RC))
...
/**
  * @brief at32f011 interrupt number definition, according to the selected device
