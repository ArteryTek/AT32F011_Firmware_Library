/**
  ******************************************************************************
  * @file     startup_at32f011.s
  * @brief    at32f011xx devices vector table for gcc toolchain.
  ...
  *             calls main()).
  *           after reset the cortex-m0plus processor is in thread mode,
...
g_pfnVectors:
  ...
  .word  HWDIV_IRQHandler                    /* Hardware divider                        */
  ...
  .word  USART4_3_IRQHandler                 /* USART4 & USART3                         */
...
*******************************************************************************/
   ...
   .thumb_set HWDIV_IRQHandler,Default_Handler
