...
void crm_reset(void)
{
  ...
  /* reset cfg register, include sclk switch, ahbdiv, apb1div, apb2div, adcdiv,
     clkout pllrcs, pllhextdiv and pllmult bits */
  CRM->cfg = 0;
...
/**
  ...
  *         - CRM_GPIOC_PERIPH_CLOCK        - CRM_GPIOF_PERIPH_CLOCK        - CRM_HWDIV_PERIPH_CLOCK       - CRM_SCFG_PERIPH_CLOCK
  *         - CRM_ADC1_PERIPH_CLOCK         - CRM_TMR1_PERIPH_CLOCK         - CRM_SPI1_PERIPH_CLOCK        - CRM_USART1_PERIPH_CLOCK
  *         - CRM_TMR15_PERIPH_CLOCK        - CRM_TMR16_PERIPH_CLOCK        - CRM_TMR17_PERIPH_CLOCK       - CRM_DEBUG_PERIPH_CLOCK
  *         - CRM_TMR3_PERIPH_CLOCK         - CRM_TMR6_PERIPH_CLOCK         - CRM_TMR14_PERIPH_CLOCK       - CRM_WWDT_PERIPH_CLOCK
  *         - CRM_SPI2_PERIPH_CLOCK         - CRM_USART2_PERIPH_CLOCK       - CRM_USART3_PERIPH_CLOCK      - CRM_USART4_PERIPH_CLOCK
  *         - CRM_I2C1_PERIPH_CLOCK         - CRM_I2C2_PERIPH_CLOCK         - CRM_PWC_PERIPH_CLOCK
  * @param  new_state (TRUE or FALSE)
  * @retval none
  */
...
/**
  ...
  *         - CRM_HWDIV_PERIPH_RESET        - CRM_SCFG_PERIPH_RESET         - CRM_EXINT_PERIPH_RESET       - CRM_ADC1_PERIPH_RESET
  *         - CRM_TMR1_PERIPH_RESET         - CRM_SPI1_PERIPH_RESET         - CRM_USART1_PERIPH_RESET      - CRM_TMR15_PERIPH_RESET
  *         - CRM_TMR16_PERIPH_RESET        - CRM_TMR17_PERIPH_RESET        - CRM_DEBUG_PERIPH_RESET       - CRM_TMR3_PERIPH_RESET
  *         - CRM_TMR6_PERIPH_RESET         - CRM_TMR14_PERIPH_RESET        - CRM_WWDT_PERIPH_RESET        - CRM_SPI2_PERIPH_RESET
  *         - CRM_USART2_PERIPH_RESET       - CRM_USART3_PERIPH_RESET       - CRM_USART4_PERIPH_RESET      - CRM_I2C1_PERIPH_RESET
  *         - CRM_I2C2_PERIPH_RESET         - CRM_PWC_PERIPH_RESET
  * @param  new_state (TRUE or FALSE)
  * @retval none
  */
