...
/**
  * @brief  enable or disable the adc precharge function.
  * @param  adc_x: select the adc peripheral.
  *         this parameter can be one of the following values:
  *         ADC1.
  * @param  new_state: new state of a/d converter.
  *         this parameter can be: TRUE or FALSE.
  *         note:precharge function need be disable when calibration.
  * @retval none
  */
void adc_precharge_enable(adc_type *adc_x, confirm_state new_state)
{
  adc_x->ctrl1_bit.precen = new_state;
}
