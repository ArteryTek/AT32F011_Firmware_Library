...
/**
  ...
  *         - DMA_FLEXIBLE_SPI2_TX        - DMA_FLEXIBLE_USART1_RX      - DMA_FLEXIBLE_USART1_TX      - DMA_FLEXIBLE_USART2_RX
  *         - DMA_FLEXIBLE_USART2_TX      - DMA_FLEXIBLE_USART3_RX      - DMA_FLEXIBLE_USART3_TX      - DMA_FLEXIBLE_USART4_RX
  *         - DMA_FLEXIBLE_USART4_TX      - DMA_FLEXIBLE_I2C1_RX        - DMA_FLEXIBLE_I2C1_TX        - DMA_FLEXIBLE_I2C2_RX
  *         - DMA_FLEXIBLE_I2C2_TX        - DMA_FLEXIBLE_TMR1_TRIG      - DMA_FLEXIBLE_TMR1_HALL      - DMA_FLEXIBLE_TMR1_OVERFLOW
  *         - DMA_FLEXIBLE_TMR1_CH1       - DMA_FLEXIBLE_TMR1_CH2       - DMA_FLEXIBLE_TMR1_CH3       - DMA_FLEXIBLE_TMR1_CH4
  *         - DMA_FLEXIBLE_TMR3_TRIG      - DMA_FLEXIBLE_TMR3_OVERFLOW  - DMA_FLEXIBLE_TMR3_CH1       - DMA_FLEXIBLE_TMR3_CH2
  *         - DMA_FLEXIBLE_TMR3_CH3       - DMA_FLEXIBLE_TMR3_CH4       - DMA_FLEXIBLE_TMR6_OVERFLOW  - DMA_FLEXIBLE_TMR15_TRIG
  *         - DMA_FLEXIBLE_TMR15_HALL     - DMA_FLEXIBLE_TMR15_OVERFLOW - DMA_FLEXIBLE_TMR15_CH1      - DMA_FLEXIBLE_TMR15_CH2
  *         - DMA_FLEXIBLE_TMR16_OVERFLOW - DMA_FLEXIBLE_TMR16_CH1      - DMA_FLEXIBLE_TMR17_OVERFLOW - DMA_FLEXIBLE_TMR17_CH1
  * @retval none
  */
...
void dma_flexible_config(dma_type* dma_x, uint8_t flex_channelx, dma_flexible_request_type flexible_request)
{
  ...
  {
    if(flex_channelx == FLEX_CHANNEL5)
    {
