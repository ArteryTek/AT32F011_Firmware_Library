...
/**
  ...
  *         - PWC_PVM_VOLTAGE_2V15
  *         - PWC_PVM_VOLTAGE_2V30
  *         - PWC_PVM_VOLTAGE_2V45
  *         - PWC_PVM_VOLTAGE_2V60
  *         - PWC_PVM_VOLTAGE_2V75
  *         - PWC_PVM_VOLTAGE_2V90
  *         - PWC_PVM_VOLTAGE_3V00
  * @retval none
  */
...
/**
  ...
  * @note:  when using low power mode, it is prohibited to enable deepsleep_debug for debugging!
  * @retval none
  */
void pwc_voltage_regulate_set(pwc_regulator_type pwc_regulator)
{
  PWC->ctrl_bit.vrlpen = pwc_regulator;
}
