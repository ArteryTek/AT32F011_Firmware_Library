/**
  **************************************************************************
  * @file     at32f011_debug.h
  * @brief    at32f011 debug header file
  **************************************************************************
  *
...
#ifndef __AT32F011_DEBUG_H
#define __AT32F011_DEBUG_H
...
typedef struct
{
  ...
  union
  {
    ...
    struct
    {
      ...
      __IO uint32_t reserved7            : 2;/* [26:25] */
      __IO uint32_t tmr14_pause          : 1;/* [27] */
      __IO uint32_t reserved8            : 4;/* [31:28] */
    } ctrl_bit;
  };
