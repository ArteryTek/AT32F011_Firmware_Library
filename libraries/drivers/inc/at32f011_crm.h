/**
  **************************************************************************
  * @file     at32f011_crm.h
  * @brief    at32f011 crm header file
  **************************************************************************
  *
...
#ifndef __AT32F011_CRM_H
#define __AT32F011_CRM_H
...
/** @addtogroup AT32F011_periph_driver
  * @{
  */
...
typedef enum
{
  ...
  CRM_HWDIV_PERIPH_CLOCK                 = MAKE_VALUE(0x14, 26), /*!< hwdiv periph clock */
  /* apb2 periph */
  ...
  CRM_DEBUG_PERIPH_CLOCK                 = MAKE_VALUE(0x18, 22), /*!< debug periph clock */
  /* apb1 periph */
...
typedef enum
{
  ...
  CRM_HWDIV_PERIPH_RESET                 = MAKE_VALUE(0x28, 26), /*!< hwdiv periph reset */
  /* apb2 periph */
  ...
  CRM_DEBUG_PERIPH_RESET                 = MAKE_VALUE(0x0C, 22), /*!< debug periph reset */
  /* apb1 periph */
...
typedef enum
{
  CRM_ADC_DIV_2                          = 0x00, /*!< ahbclk div2 to adcclk */
  CRM_ADC_DIV_4                          = 0x01, /*!< ahbclk div4 to adcclk */
  CRM_ADC_DIV_6                          = 0x02, /*!< ahbclk div6 to adcclk */
  CRM_ADC_DIV_8                          = 0x03, /*!< ahbclk div8 to adcclk */
  CRM_ADC_DIV_3                          = 0x04, /*!< ahbclk div3 to adcclk */
  CRM_ADC_DIV_12                         = 0x05, /*!< ahbclk div12 to adcclk */
  CRM_ADC_DIV_5                          = 0x06, /*!< ahbclk div5 to adcclk */
  CRM_ADC_DIV_16                         = 0x07  /*!< ahbclk div16 to adcclk */
} crm_adc_div_type;
...
typedef enum
{
  CRM_I2C_CLOCK_SOURCE_PCLK              = 0x00, /*!< select pclk as i2c1 clock source */
  CRM_I2C_CLOCK_SOURCE_SCLK              = 0x01, /*!< select sclk as i2c1 clock source */
  CRM_I2C_CLOCK_SOURCE_HICK48            = 0x02  /*!< select hick48 as i2c1 clock source */
...
typedef enum
{
  CRM_USART_CLOCK_SOURCE_PCLK            = 0x00, /*!< select pclk as usart clock source */
  CRM_USART_CLOCK_SOURCE_SCLK            = 0x01, /*!< select sclk as usart clock source */
  CRM_USART_CLOCK_SOURCE_HICK48          = 0x02, /*!< select hick48 as usart clock source */
  CRM_USART_CLOCK_SOURCE_LEXT            = 0x03  /*!< select lext as usart clock source */
...
typedef struct
{
  ...
  union
  {
    ...
    struct
    {
      ...
      __IO uint32_t hicktrim             : 3; /* [4:2] */
      __IO uint32_t reserved1            : 3; /* [7:5] */
      __IO uint32_t hickcal              : 6; /* [13:8] */
  ...
  union
  {
    ...
    struct
    {
      ...
      __IO uint32_t reserved5            : 3; /* [21:19] */
      __IO uint32_t debugrst             : 1; /* [22] */
  ...
  union
  {
    ...
    struct
    {
      ...
      __IO uint32_t reserved6            : 3; /* [25:23] */
      __IO uint32_t hwdiven              : 1; /* [26] */
      __IO uint32_t reserved7            : 5; /* [31:27] */
    } ahben_bit;
  };
  ...
  union
  {
    ...
    struct
    {
      ...
      __IO uint32_t reserved3            : 3; /* [25:23] */
      __IO uint32_t hwdivrst             : 1; /* [26] */
  ...
  union
  {
    ...
    struct
    {
      ...
      __IO uint32_t reserved2            : 11;/* [27:17] */
      __IO uint32_t clkoutdiv            : 4; /* [31:28] */
    } misc1_bit;
  };

  /**
    * @brief crm reserved1 register, offset:0x34~0x44
    */
  __IO uint32_t reserved1[5];

  /**
    * @brief crm piclks register, offset:0x48
    */
  union
  {
    ...
    struct
    {
      ...
      __IO uint32_t reserved2            : 8; /* [11:4] */
  ...
  /**
    * @brief crm reserved2 register, offset:0x4C~0x50
    */
