/**
  **************************************************************************
  * @file     at32f011_scfg.h
  * @brief    at32f011 system config header file
  **************************************************************************
  *
...
#ifndef __AT32F011_SCFG_H
#define __AT32F011_SCFG_H
...
typedef enum
{
  SCFG_ULTRA_DRIVEN_PB8                  = 0x00010000,
  SCFG_ULTRA_DRIVEN_PB9                  = 0x00020000,
...
/**
  * @brief scfg sram odd parity error lock type
  */
typedef enum
{
  SCFG_SRAM_OPE_ERR               = 0x00, /* sram odd parity error */
  SCFG_SRAM_OPERR_LK_ENABLE                = 0x01, /* sram odd parity error */
} scfg_sram_ope_type;
...
typedef struct
{
  ...
  union
  {
    ...
    struct
    {
      ...
      __IO uint32_t reserved2            : 8; /* [8] */
      __IO uint32_t pb8_uh               : 1; /* [16] */
      __IO uint32_t pb9_uh               : 1; /* [17] */
  ...
  union
  {
    ...
    struct
    {
      ...
      __IO uint32_t reserved3            : 23;/* [31:9] */     
    } cfg2_bit;
  };
} scfg_type;
