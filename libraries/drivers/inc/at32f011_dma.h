/**
  **************************************************************************
  * @file     at32f011_dma.h
  * @brief    at32f011 dma header file
  **************************************************************************
  *
...
#ifndef __AT32F011_DMA_H
#define __AT32F011_DMA_H
...
typedef enum
{
  ...
  DMA_FLEXIBLE_USART1_RX                 = 0x32, /*!< usart1_rx flexible request id */
  DMA_FLEXIBLE_USART1_TX                 = 0x33, /*!< usart1_tx flexible request id */
  DMA_FLEXIBLE_USART2_RX                 = 0x34, /*!< usart2_rx flexible request id */
  DMA_FLEXIBLE_USART2_TX                 = 0x35, /*!< usart2_tx flexible request id */
  DMA_FLEXIBLE_USART3_RX                 = 0x36, /*!< usart3_rx flexible request id */
  DMA_FLEXIBLE_USART3_TX                 = 0x37, /*!< usart3_tx flexible request id */
  DMA_FLEXIBLE_USART4_RX                 = 0x38, /*!< usart4_rx flexible request id */
  DMA_FLEXIBLE_USART4_TX                 = 0x39, /*!< usart4_tx flexible request id */
...
typedef struct
{
  ...
  union
  {
    ...
    struct
    {
      ...
      __IO uint32_t reserved1            : 16;/* [23:8] */
