...
#include "at32f011_board.h"
#include "at32f011_clock.h"
#include "at32f011_int.h"
#include <stdio.h>

/** @addtogroup AT32F011_periph_examples
  * @{
  */

/** @addtogroup 011_SPI_fullduplex_polling SPI_fullduplex_polling
  * @{
  */
...
uint8_t spi1_buffer_tx[BUFFER_SIZE] = {0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08,
...
uint8_t spi1_buffer_rx[BUFFER_SIZE], spi2_buffer_rx[BUFFER_SIZE];
...
/**
  ...
  * @param  spi1_mode : the mode of spi1
...
int main(void)
{
  ...
  while(tx_index < BUFFER_SIZE)
  {
    ...
    spi1_buffer_rx[rx_index++] = spi_i2s_data_receive(SPI1);
  }
  ...
  transfer_status1 = buffer_compare(spi2_buffer_rx, spi1_buffer_tx, BUFFER_SIZE);
  transfer_status2 = buffer_compare(spi1_buffer_rx, spi2_buffer_tx, BUFFER_SIZE);
  ...
  /* test result:the data check */
  transfer_status3 = buffer_compare(spi2_buffer_rx, spi1_buffer_tx, BUFFER_SIZE);
  transfer_status4 = buffer_compare(spi1_buffer_rx, spi2_buffer_tx, BUFFER_SIZE);
