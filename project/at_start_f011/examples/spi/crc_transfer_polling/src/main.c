...
/** @addtogroup 011_SPI_crc_transfer_polling SPI_crc_transfer_polling
  * @{
  */
...
uint16_t spi1_buffer_tx[BUFFER_SIZE] = {0x0102, 0x0304, 0x0506, 0x0708, 0x090A, 0x0B0C, 0x0D0E, 0x0F10,
...
uint16_t spi1_buffer_rx[BUFFER_SIZE], spi2_buffer_rx[BUFFER_SIZE];
