...
/** @addtogroup 011_USART_polarity_reverse USART_polarity_reverse
  * @{
  */
...
void usart_configuration(void)
{
  ...
  usart_dt_polarity_reverse(USART2, TRUE);
  usart_transmit_pin_polarity_reverse(USART2, TRUE);
  usart_receive_pin_polarity_reverse(USART2, TRUE);
  ...
  usart_dt_polarity_reverse(USART1, TRUE);
  usart_transmit_pin_polarity_reverse(USART1, TRUE);
  usart_receive_pin_polarity_reverse(USART1, TRUE);
