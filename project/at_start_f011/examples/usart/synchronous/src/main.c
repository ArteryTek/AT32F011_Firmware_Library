...
/** @addtogroup 011_USART_synchronous USART_synchronous
  * @{
  */
...
/**
  * @brief  config usart2 and usart3
  * @param  none
  * @retval none
  */
void usart_spi_configuration(void)
{
  ...
  gpio_pin_mux_config(GPIOA, GPIO_PINS_SOURCE4, GPIO_MUX_1);

  /* configure the spi2 mosi, miso and ck pin */
  gpio_init_struct.gpio_drive_strength = GPIO_DRIVE_STRENGTH_STRONGER;
  gpio_init_struct.gpio_out_type = GPIO_OUTPUT_PUSH_PULL;
  gpio_init_struct.gpio_mode = GPIO_MODE_MUX;
  gpio_init_struct.gpio_pins = GPIO_PINS_15 | GPIO_PINS_14 | GPIO_PINS_13;
