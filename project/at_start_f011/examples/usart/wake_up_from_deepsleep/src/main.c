...
/** @addtogroup 011_USART_wake_up_from_deepsleep USART_wake_up_from_deepsleep
  * @{
  */

#define USART1_BUFFER_SIZE            (128)
#define USART1_ID_MATCH               (0x35)

uint8_t usart1_rx_buffer[USART1_BUFFER_SIZE];
uint8_t usart1_rx_counter = 0x00;

uint8_t text_info[] = "enter deep sleep, '0xB5' character for waking up mcu..\r\n";
