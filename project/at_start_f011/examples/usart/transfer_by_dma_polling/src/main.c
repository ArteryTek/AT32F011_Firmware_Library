...
/** @addtogroup 011_USART_transfer_by_dma_polling USART_transfer_by_dma_polling
  * @{
  */
...
void dma_configuration(void)
{
  ...
  dma_flexible_config(DMA1, FLEX_CHANNEL4, DMA_FLEXIBLE_USART2_TX);
  ...
  dma_flexible_config(DMA1, FLEX_CHANNEL5, DMA_FLEXIBLE_USART2_RX);
  ...
  dma_flexible_config(DMA1, FLEX_CHANNEL2, DMA_FLEXIBLE_USART1_TX);
  ...
  dma_flexible_config(DMA1, FLEX_CHANNEL3, DMA_FLEXIBLE_USART1_RX);
...
int main(void)
{
  ...
  while((dma_flag_get(DMA1_FDT2_FLAG) == RESET) || (dma_flag_get(DMA1_FDT3_FLAG) == RESET) || \
        (dma_flag_get(DMA1_FDT4_FLAG) == RESET) || (dma_flag_get(DMA1_FDT5_FLAG) == RESET));
