...
/** @addtogroup 011_USART_half_duplex USART_half_duplex
  * @{
  */
...
uint8_t usart2_tx_buffer[] = "usart half-duplex transfer: usart2 -> usart1";
uint8_t usart1_tx_buffer[] = "usart half-duplex transfer: usart1 -> usart2";
