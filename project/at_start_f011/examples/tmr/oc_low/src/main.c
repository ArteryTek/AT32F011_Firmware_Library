...
/** @addtogroup 011_TMR_oc_low TMR_oc_low
  * @{
  */
...
int main(void)
{
  ...
  prescaler_value = (uint16_t)(crm_clocks_freq_struct.apb1_freq / 500) - 1;
  ...
  /* reset pa.00, pa.01, pa.02 and pa.03 pins */
  gpio_bits_reset(GPIOA, GPIO_PINS_0 | GPIO_PINS_1 | GPIO_PINS_2 | GPIO_PINS_3);
