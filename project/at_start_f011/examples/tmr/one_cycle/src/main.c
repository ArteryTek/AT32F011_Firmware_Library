...
/** @addtogroup 011_TMR_one_cycle TMR_one_cycle
  * @{
  */
...
void gpio_configuration(void)
{
  ...
  /* timer1 input pin configuration */
...
int main(void)
{
  ...
  prescaler_value = (uint16_t)(crm_clocks_freq_struct.apb2_freq / 24000000) - 1;

  /* tmr base configuration */
  tmr_base_init(TMR1, 65535, prescaler_value);
  ...
  tmr_channel_value_set(TMR1, TMR_SELECT_CHANNEL_1, 16383);
