...
/** @addtogroup 011_TMR_hall_xor_tmr3 TMR_hall_xor_tmr3
  * @{
  */
...
int main(void)
{
  ...
  /* enable tmr3/gpioa/gpiob clock */
  crm_periph_clock_enable(CRM_TMR3_PERIPH_CLOCK, TRUE);
  crm_periph_clock_enable(CRM_GPIOA_PERIPH_CLOCK, TRUE);
  crm_periph_clock_enable(CRM_GPIOB_PERIPH_CLOCK, TRUE);

  /* hall signal (pa0 ,pa1 ,pa2) and trigger flag signal(pa8) configuration */
  gpio_init_struct.gpio_pins = GPIO_PINS_0 | GPIO_PINS_1 | GPIO_PINS_2 | GPIO_PINS_8;
  ...
  /* tmr3 and tmr3 counter mode configuration */
