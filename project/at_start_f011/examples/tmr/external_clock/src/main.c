...
/** @addtogroup 011_TMR_external_clock TMR_external_clock
  * @{
  */
...
int main(void)
{
  ...
  tmr_channel_value_set(TMR3, TMR_SELECT_CHANNEL_1, 50);
