...
/** @addtogroup 011_WWDT_reset WWDT_reset
  * @{
  */
...
int main(void)
{
  ...
  /* enable wwdt
   ...
   timeout = 64 * (32768 / 80000000 ) = 0.0262s = 26.2ms
   window  = 16 * (32768 / 80000000 ) = 0.0065s = 6.5ms
  ...
  */
  ...
  while(1)
  {
    ...
    /* the reload time must within the window (10ms > 6.5ms) */
    delay_ms(10);
