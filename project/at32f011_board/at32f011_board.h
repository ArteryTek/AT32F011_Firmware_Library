...
#ifndef __AT32F011_BOARD_H
#define __AT32F011_BOARD_H
...
/**
  ...
  * 1. at-start-f011 v1.x boards
  * if define AT_START_F011_V1, the header file support at-start-f011 v1.x board
  */

#if !defined (AT_START_F011_V1)
#error "please select first the board at-start device used in your application (in at32f011_board.h file)"
#endif
